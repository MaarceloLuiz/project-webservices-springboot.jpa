...
import com.webservicesproject.project.services.OrderService;

@RestController
@RequestMapping(value = "/orders")
public class OrderResource {
	
	@Autowired //in order to the automatic injection using 'Autowired' works, we have to set the 'OrderService' as a 'Component' of Spring
